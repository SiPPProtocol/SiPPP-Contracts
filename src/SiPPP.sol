...
contract SiPPP is AccessControl, RecoverMessage {
    ...
    function registerPhoto(address _wallet, TransactionData calldata _sipppTxn)
        public
        payable
        onlyApp(_sipppTxn.photoIpfsHash, _sipppTxn.rawSig)
    {
        ...
        s_userAddresses.push(_wallet);
        s_userPhotos[_wallet].push(_sipppTxn);
        s_photoSippped[_sipppTxn.photoIpfsHash] = true;
        s_userSippped[_wallet] = true;
